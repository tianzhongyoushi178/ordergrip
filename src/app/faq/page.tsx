...
const faqs = [
    ...
    {
        q: "遠方でもオーダー可能ですか？",
        a: "はい、可能です。Zoom等を用いたオンラインヒアリングにて対応させていただきます。試作バレルも郵送にてご確認いただけます。",
    },
    {
        q: "現在使用しているバレルと同じ形状で作れますか？",
        a: "はい、可能です。現物をお預かりし、3Dスキャンおよびノギス測定にて数値を出し、再現いたします。廃盤になったモデルの復刻などもご相談ください。",
    },
    {
        q: "リテイク（修正）は可能ですか？",
        a: "設計段階での修正は無制限です。試作バレル作成後の修正は2回まで無料、3回目以降は別途費用をいただく場合がございます。",
    },
    {
        q: "素材は何を使用していますか？",
        a: "タングステン90%〜95%を使用しております。比重の調整も可能ですのでご相談ください。",
    },
];
